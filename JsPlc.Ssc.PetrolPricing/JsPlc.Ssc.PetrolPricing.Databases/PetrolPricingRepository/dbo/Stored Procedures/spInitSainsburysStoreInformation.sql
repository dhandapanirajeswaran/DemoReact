...
AS
	...
	BEGIN
		...
		UPDATE dbo.Site SET CatNo=26246, PfsNo=1241 WHERE StoreNo=2241 -- "SAINSBURYS FAVERSHAM AUTOMAT"
		UPDATE dbo.Site SET CatNo=11719, PfsNo=1509 WHERE StoreNo=6509 -- "SAINSBURYS KINGS ROAD BEBINGTON"
		UPDATE dbo.Site SET CatNo=26247, PfsNo=1670 WHERE StoreNo=2670 -- "SAINSBURYS LIVERPOOL GREAT HOMER STREET"
		UPDATE dbo.Site SET CatNo=6387, PfsNo=1802 WHERE StoreNo=6511 -- "SAINSBURYS MELTON ROAD NOTTINGHAM"
		UPDATE dbo.Site SET CatNo=3301, PfsNo=1801 WHERE StoreNo=6510 -- "SAINSBURYS NEW ROAD BRIXHAM"
		UPDATE dbo.Site SET CatNo=11779, PfsNo=1800 WHERE StoreNo=6549 -- "SAINSBURYS PENSBY ROAD THINGWALL"
		UPDATE dbo.Site SET CatNo=26238, PfsNo=1301 WHERE StoreNo=2301 -- "SAINSBURYS SUDBURY AUTOMAT"
